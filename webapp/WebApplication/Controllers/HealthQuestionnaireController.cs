...
namespace K9.WebApplication.Controllers
{
    ...
    public class HealthQuestionnaireController : BasePureController
    {
        ...
        [Route("genetic-profile/questionnaire/overview/id/")]
        public ActionResult GeneticProfileTestOverview(Guid externalId)
        {
            var hq = _healthQuestionnaireService.GetHealthQuestionnaireById(externalId);
        ...
        private void AddModelErrors(HealthQuestionnaire model, Antlr.Runtime.Misc.Func<QuestionCategoryAttribute, bool> condition, bool isActive = true)
        {
